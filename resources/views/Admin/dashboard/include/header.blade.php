...
<head>
    ...
    <!-- FontAwesome JS-->
    <script defer src="{{asset('assets/Admin/dashboard/plugins/fontawesome/js/all.min.js')}}"></script>

    <!-- App CSS -->
    <link id="theme-style" rel="stylesheet" href="{{asset('assets/Admin/dashboard/css/portal.css')}}">
            ...
            <div class="container-fluid py-2">
                ...
                <div class="app-header-content">
                    <div class="row justify-content-between align-items-center">
                        ...
                        <!-- ending menu icon for mobile  -->

                        <!-- search box mobile and desktop -->
                        <!-- trigger in mobile search box -->
                        <div class="search-mobile-trigger d-sm-none col">
                            <i class="search-mobile-trigger-icon fas fa-search"></i>
                        </div>
                        <!-- end trigger in mobile search box -->
                        <!-- search box -->
                        ...
                        <!-- ending search box -->
                        <!-- ending search box mobile and desktop -->
                        ...
                        <div class="app-utilities col-auto">
                            ...
                            <div class="app-utility-item app-notifications-dropdown dropdown">
                                ...
                                <a class="dropdown-toggle no-toggle-arrow" id="notifications-dropdown-toggle"
                                    ...
                                    <span class="icon-badge">3</span> <!-- Badge -->
                                </a>
                                <!-- ending notification button icon  -->
                    ...
                    <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z" />
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                    ...
                                    <img src="{{ asset('assets/Admin/images/ecomm-dark.png') }}" alt="user profile">
                                </a>
